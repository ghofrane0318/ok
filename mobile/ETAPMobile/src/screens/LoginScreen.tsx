  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Animated.View style={[styles.hero, { opacity: fadeAnim, transform: [{ translateY: slideAnim }] }]}>
        ...
        <Text style={styles.appName}>ETAP Mobile</Text>
      ...
      <Animated.View style={[styles.sheet, { opacity: fadeAnim, transform: [{ scale: scaleAnim }] }]}>
        ...
        <View style={styles.instructionCard}>
          ...
          <View style={styles.instructionText}>
            ...
            <Text style={styles.instructionDesc}>
              Connectez-vous sur le portail web ETAP, allez dans votre{' '}
        ...
        <View style={styles.steps}>
          {[
            { num: '1', text: 'Ouvrez le portail ETAP sur votre ordinateur' },
        ...
        <View style={styles.rolesRow}>
          {['Client', 'Fournisseur', 'Commercial', 'Transporteur'].map((role) => (
        ...
        <Text style={styles.footer}>v2.0.0 · © 2026 ETAP</Text>
      </Animated.View>
    </SafeAreaView>
  );
}
